...
const outletAnalyticsEventSchema = new Schema<IOutletAnalyticsEvent>(
  {
    ...
    mall_key: { type: String },
    qr_scan_type: { type: String },
...
outletAnalyticsEventSchema.index({ mall_key: 1, event_type: 1, timestamp: -1 });
outletAnalyticsEventSchema.index({ qr_scan_type: 1, timestamp: -1 });
