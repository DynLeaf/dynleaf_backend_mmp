...
router.post('/sales/priority/:customerId/message', requireRole('salesman'), dashboardController.sendPriorityMessage);
router.post('/sales/priority/:customerId/seen', requireRole('salesman'), dashboardController.markPriorityTaskSeen);
...
router.post('/admin/priority/:customerId/message', requireRole('admin'), dashboardController.sendAdminPriorityMessage);
router.post('/admin/priority/:customerId/seen', requireRole('admin'), dashboardController.markAdminPriorityTaskSeen);
